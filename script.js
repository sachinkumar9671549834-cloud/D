...
const sampleQuestionsGD = [
    {
        ...
        hi: {
            ...
            options: ["महात्मा गांधी", "जवाहरलाल नेहरू", "सुभाष चंद्र बोस", "डॉ. राजेंद्र Prasad"]
        },
        correct: 1
    },
    {
...
function loadHomeScreen(updateHistory = true) {
    ...
    if (!app) return;
    app.innerHTML = `
        <div class="app-title" style="text-align:center; font-weight:bold; color:var(--gold); margin-top:20px;">INDIAN ARMY</div>
        <div class="app-subtitle" style="text-align:center; color:#fff; font-size:12px; margin-bottom:20px;">AGNIVEER EXAM PORTAL</div>
