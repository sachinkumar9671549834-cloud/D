...
const sampleQuestionsGD = [
    ...
    },
    {
        ...
        hi: {
            ...
            options: ["CO2", "H2O", "O2", "NaCl"],
            sol: "पानी का रासायनिक सूत्र H2O है, जिसका अर्थ है कि इसमें दो हाइड्रोजन परमाणु और एक ऑक्सीजन परमाणु होता है।"
        },
        correct: 1
    },
    {
...
function renderCBTInterface() {
    ...
    app.innerHTML = `
        ...
        <!-- 4 बटन वाला बॉटम नेविगेशन (Previous जोड़ा गया) -->
        <div style="display:flex; flex-direction:column; gap:10px; margin-top:20px;">
            <div style="display:flex; justify-content:space-between; gap:8px;">
                <button onclick="previousQuestion()" id="btn-prev" style="flex:1; background:#4b5563; color:#fff; border:none; padding:12px 5px; border-radius:6px; font-size:13px; font-weight:bold; cursor:pointer;">⬅ Previous</button>
                <button onclick="clearAnswer()" style="flex:1; background:#ef4444; color:#fff; border:none; padding:12px 5px; border-radius:6px; font-size:13px; font-weight:bold; cursor:pointer;">Clear</button>
            </div>
            <div style="display:flex; justify-content:space-between; gap:8px;">
...
function renderPaletteGrid() {
    ...
    currentQuestions.forEach((_, idx) => {
        ...
        // यदि बुकमार्क है तो स्पेशल बॉर्डर
...
function processFinalSubmit() {
    ...
    currentQuestions.forEach((q, idx) => {
        ...
        // विस्तृत सलूशन कार्ड जनरेट करना
        let qBlockHTML = `
        ...
        // कैटेगरी वाइज़ छांटना (Correct, Wrong, Unattempted)
        ...
        // बुकमार्क किए गए प्रश्नों की लिस्ट अलग बनाना
    ...
    // स्कोरकार्ड स्क्रीन रेंडर करना (इमेज 44400.jpg के नीचे नए सेक्शन जोड़ना)
    app.innerHTML = `
        ...
        <!-- 📑 नया अनुभाग: प्रश्न एवं विस्तृत समाधान खंड -->
        ...
        <!-- 📌 नया अनुभाग: बुकमार्क किए गए प्रश्न -->
